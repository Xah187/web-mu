  ...
  useEffect(() => {
    if (isAuthenticated && user?.data) {
      ...
      if (jobDescription === 'موظف') {
        ...
        // مسئول الطلبيات - يمكنه تشييك الطلبيات والوصول للعهد
        permissions = [
          'تشييك الطلبات',
          'إنشاء طلبات',
          'covenant'
        ...
        bossType = '';
      } else if (jobDescription === 'مهندس الموقع') {
        // مهندس الموقع
        permissions = [
          'تشييك الانجازات الفرعية',
          'إضافة تأخيرات',
        ...
        bossType = '';
      } else if (jobDescription === 'مهندس مشروع') {
        // مهندس مشروع
        permissions = [
          'إضافة مرحلة رئيسية',
          'تعديل مرحلة رئيسية',
        ...
        bossType = '';
      } else if (jobDescription === 'مشرف الموقع') {
        // مشرف الموقع
        permissions = [
          'اضافة مرحلة فرعية',
          'تشييك الانجازات الفرعية',
        ...
        bossType = '';
      } else if (jobDescription === 'إستشاري موقع' || jobDescription === 'استشاري موقع') {
        // استشاري موقع
        permissions = [
          'اقفال المرحلة',
          'اضافة مرحلة فرعية',
        ...
        bossType = '';
      } else if (jobDescription === 'مستشار جودة') {
        // مستشار جودة
        permissions = [
          'اقفال المرحلة',
          'تشييك الانجازات الفرعية'
        ...
        bossType = '';
      } else if (jobDescription === 'مدخل بيانات') {
        // مدخل بيانات
        permissions = [
          'انشاء مجلد او تعديله',
          'رفع ملف'
