            ...
            >
              ...
              <div className="flex gap-6">
                ...
                <button
                  onClick={onClose}
                  disabled={isLoading}
                  className="flex-1 text-center rounded-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg disabled:opacity-50 active:scale-[0.98]"
                  style={{
                    fontSize: `${scale(16 + size)}px`,
                    color: 'var(--color-text-primary)',
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = 'translateY(-1px)';
                    e.currentTarget.style.boxShadow = '0 6px 20px rgba(0, 0, 0, 0.12)';
                    e.currentTarget.style.backgroundColor = 'rgba(220, 38, 38, 0.14)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = 'translateY(0)';
                    e.currentTarget.style.boxShadow = '0 4px 12px rgba(0, 0, 0, 0.08)';
                    e.currentTarget.style.backgroundColor = 'rgba(220, 38, 38, 0.10)';
                  }}
                >
                  {isLoading ? (
