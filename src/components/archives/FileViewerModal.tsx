        ...
        return (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 font-ibm-arabic-medium mb-6">
              اضغط على تحميل لفتح الملف
            </p>
            <button
              onClick={handleDownload}
              className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors font-ibm-arabic-medium flex items-center space-x-2 rtl:space-x-reverse mx-auto"
            >
